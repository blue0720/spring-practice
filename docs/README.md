...
『忘却の取引』(Spring Boot構成) の開発チケット。CLAUDE.md記載の開発フェーズ・機能要件を元に、
フェーズ単位で連番のマークダウンファイルに分割している。

各チケット内のTodoは `- [ ]` 未着手 → `- [〇]` 完了 で管理する。

原典資料:
- `C:\Users\k_tai\OneDrive\Desktop\01_企画書.md`
- `C:\Users\k_tai\OneDrive\Desktop\02_要件定義書.md`
